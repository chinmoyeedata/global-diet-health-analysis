...
##### Rather than just repeating the static charts from the notebook, the Tableau dashboard is built to let you explore the data yourself:

* ##### An interactive scatter plot with trend lines, letting you swap between any diet variable and any health outcome
* ##### A world map colored by health outcome
* ##### A world map colored by diet variable
* ##### A correlation view showing which diet factors relate most strongly to each health outcome
* ##### Every chart updates together when the diet and health metric is changed
